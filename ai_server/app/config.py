...
NOTIFICATION_COOLDOWN_SECONDS = int(os.getenv("BUZZ_NOTIFICATION_COOLDOWN_SECONDS", "30"))

# 지속 분석 상태 전환의 임시 운영 기준.
DANGER_CONSECUTIVE_DETECTIONS = int(os.getenv("BUZZ_DANGER_CONSECUTIVE_DETECTIONS", "1"))
