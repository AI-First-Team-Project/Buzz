...
import { parseOperationalTime } from '../utils/formatDateTime';
import styles from './Topbar.module.css';

const probability = value => `${Math.round((Number(value) || 0) * 100)}%`;
const timestamp = value => parseOperationalTime(value).toLocaleString('ko-KR', { timeZone:'Asia/Seoul', month:'numeric', day:'numeric', hour:'2-digit', minute:'2-digit' });
