...
export function SoundTestIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M3 12h2.5l2-6 3 14 2.5-11 2 3H21" />
    </svg>
  );
}
...
export function DoorIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      ...
      <path d="M14.5 12v.01" strokeWidth="2.4" />
    </svg>
  );
}
...
export function UploadMusicIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
...
export function InfoIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <circle cx="12" cy="12" r="8.5" />
      <path d="M12 11v5.5" />
      <path d="M12 8v.01" strokeWidth="2.4" />
    </svg>
  );
}
