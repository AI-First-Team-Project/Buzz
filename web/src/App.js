...
export function App() {
    return (_jsx(MonitoringProvider, { children: _jsx(Routes, { children: _jsxs(Route, { element: _jsx(Layout, {}), children: [_jsx(Route, { index: true, element: _jsx(Dashboard, {}) }), _jsx(Route, { path: "sites", element: _jsx(Worksites, {}) }), _jsx(Route, { path: "analysis", element: _jsx(AIAnalysis, {}) }), _jsx(Route, { path: "history", element: _jsx(History, {}) }), _jsx(Route, { path: "settings", element: _jsx(Settings, {}) }), _jsx(Route, { path: "sound-test", element: _jsx(SoundTest, {}) })] }) }) }));
}
