  ...
  return (
    <div>
      ...
      <section className={`${styles.summaryCard} ${danger ? styles.summaryDanger : ''}`}>
        <div className={styles.summaryWave}>
          <svg viewBox="0 0 100 32" preserveAspectRatio="none" className={styles.summaryWaveSvg} aria-hidden="true">
            {wave.map((h, i) => {
        ...
        <div className={styles.summaryBody}>
          ...
          <div className={styles.bigResult}>
            <span>{KOREAN_LABEL[site.aiLabel]}</span>
          ...
          <div className={styles.signalGrid}>
            ...
            <div className={styles.signalCell}>
              <span>감지 강도</span>
              <b>{site.aiConfidence >= 90 ? '강함' : site.aiConfidence >= 70 ? '보통' : '약함'}</b>
            </div>
          </div>

          {danger && (
            <p className={styles.dangerBanner}>
              ⚠ 말벌 특징이 강하게 감지되었습니다! 이 지역에 벌집이 있는지 확인해 주세요.{' '}
              {dominantBand.replace('약 ', '')} 대역에서 반복적인 신호가 감지되었습니다.
            </p>
          )}
